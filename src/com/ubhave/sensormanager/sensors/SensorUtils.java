...
public class SensorUtils
{
	...
	public static SensorConfig getDefaultSensorConfig(int sensorType)
	{
		...
		case SensorUtils.SENSOR_TYPE_ACCELEROMETER:
			sensorConfig.set(SensorConfig.POST_SENSE_SLEEP_LENGTH_MILLIS, Constants.ACCELEROMETER_SLEEP_INTERVAL);
		...
		case SensorUtils.SENSOR_TYPE_BLUETOOTH:
			sensorConfig.set(SensorConfig.POST_SENSE_SLEEP_LENGTH_MILLIS, Constants.BLUETOOTH_SLEEP_INTERVAL);
		...
		case SensorUtils.SENSOR_TYPE_LOCATION:
			sensorConfig.set(SensorConfig.POST_SENSE_SLEEP_LENGTH_MILLIS, Constants.LOCATION_SLEEP_INTERVAL);
		...
		case SensorUtils.SENSOR_TYPE_MICROPHONE:
			sensorConfig.set(SensorConfig.POST_SENSE_SLEEP_LENGTH_MILLIS, Constants.MICROPHONE_SLEEP_INTERVAL);
		...
		case SensorUtils.SENSOR_TYPE_WIFI:
			sensorConfig.set(SensorConfig.POST_SENSE_SLEEP_LENGTH_MILLIS, Constants.WIFI_SLEEP_INTERVAL);
